export default function TermsPage() {
  return <main className="legal-page">
    ...
    <article className="legal-document"><p className="eyebrow">INFORMACIÓN LEGAL</p><h1>Términos y<br /><em>condiciones</em></h1><p className="legal-intro">Estos términos establecen cómo trabajamos cada pedido para que tu detalle llegue con la atención que merece.</p><p className="legal-date">Última actualización: septiembre de 2026</p>
      ...
      <section><h2>4. Envíos y recojo</h2><p>El costo de envío varía según la zona de entrega en Huaral y se informa antes de confirmar el pedido. Para entrega, es responsabilidad del cliente proporcionar una dirección y referencia correctas, además de asegurar que exista una persona disponible para recibir el arreglo. Para recojo, solicitamos respetar la hora acordada.</p></section>
