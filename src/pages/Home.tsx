...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="trust" aria-label="Por qu? elegir Bloom?"><div className="trust-inner"><div className="trust-intro"><p className="eyebrow">HECHO PARA REGALAR</p><h2>Detalles pensados<br />para quedarse.</h2></div><div className="trust-list"><article><span>01</span><h3>Hecho a mano</h3><p>Cada dise?o se prepara con cuidado, uno a uno.</p></article><article><span>02</span><h3>Flores eternas</h3><p>Un detalle que conserva su belleza por mucho m?s tiempo.</p></article><article><span>03</span><h3>Personalizable</h3><p>Colores, mensaje y complementos elegidos para esa persona.</p></article><article><span>04</span><h3>Con anticipaci?n</h3><p>Reserva tu pedido con al menos 2 d?as de anticipaci?n.</p></article></div></div></section>
      ...
      <a className="floating-whatsapp" href={`https://wa.me/${whatsapp}?text=${encodeURIComponent('Hola, me gustar?a conocer m?s sobre los arreglos de Bloom?.')}`} target="_blank" rel="noreferrer" aria-label="Escribir a Bloom? por WhatsApp"><MessageCircle size={21} /><span>WhatsApp</span></a>
